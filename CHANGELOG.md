...
## [0.6.2](https://github.com/Blobscan/blobscan-indexer.rs/compare/v0.6.1...v0.6.2) - 2026-09-23

### Fixed

- surface the cause of a failed slot instead of just the block root
- log time_since_block as human-readable duration
